...
> **setLayerLegendDisplay**(`params`: [`SetLayerLegendDisplayParams`](SetLayerLegendDisplayParams.md)): `Promise`\<`void`>
...
| Parameter | Type                                                            |
| --------- | --------------------------------------------------------------- |
| `params`  | [`SetLayerLegendDisplayParams`](SetLayerLegendDisplayParams.md) |
