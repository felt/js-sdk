...
> **getLayerCalculation**(`params`: [`GetLayerCalculationParams`](GetLayerCalculationParams.md)): `Promise`\<`number`>
...
| Parameter | Type                                                        |
| --------- | ----------------------------------------------------------- |
| `params`  | [`GetLayerCalculationParams`](GetLayerCalculationParams.md) |
