...
> **setLayerLegendVisibility**(`params`: [`SetLayerLegendVisibilityParams`](SetLayerLegendVisibilityParams.md)): `Promise`\<`void`>
...
| Parameter | Type                                                                  |
| --------- | --------------------------------------------------------------------- |
| `params`  | [`SetLayerLegendVisibilityParams`](SetLayerLegendVisibilityParams.md) |
