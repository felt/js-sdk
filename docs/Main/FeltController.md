...
> **getLayerCapabilities**(`layerId`: `string`): `Promise`\<[`LayerCapability`](../Layers/LayerCapability.md)\[]>
...
`Promise`\<[`LayerCapability`](../Layers/LayerCapability.md)\[]>
...
[LayersController.createLayersFromGeoJson](../Layers/LayersController.md#createlayersfromgeojson) report `localData` instead, because
