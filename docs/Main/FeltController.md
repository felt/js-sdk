...
* [`ViewportController`](../Viewport/ViewportController.md).[`UiController`](../UI/UiController.md).[`LayersController`](../Layers/LayersController.md).[`ElementsController`](../Elements/ElementsController.md).[`SelectionController`](../Selection/SelectionController.md).[`InteractionsController`](../Interactions/InteractionsController.md).[`ToolsController`](../Tools/ToolsController.md).[`MiscController`](../Misc/MiscController.md).[`BasemapsController`](../Basemaps/BasemapsController.md).[`CollaborationController`](../Collaboration/CollaborationController.md)
...
> **broadcast**(`params`: \{ `message`: [`JsonValue`](../Collaboration/JsonValue.md); }): `Promise`\<`void`>
...
| Parameter        | Type                                                          | Description                                             |
| ---------------- | ------------------------------------------------------------- | ------------------------------------------------------- |
| `params`         | \{ `message`: [`JsonValue`](../Collaboration/JsonValue.md); } | -                                                       |
| `params.message` | [`JsonValue`](../Collaboration/JsonValue.md)                  | The opaque, JSON-serializable message to send to peers. |
...
> **setBroadcastState**(`params`: \{ `state`: [`JsonValue`](../Collaboration/JsonValue.md); }): `Promise`\<`void`>
...
Unlike [CollaborationController.broadcast](../Collaboration/CollaborationController.md#broadcast), which sends a one-off
...
joins afterwards, via [CollaborationController.onBroadcastStateChange](../Collaboration/CollaborationController.md#onbroadcaststatechange).
...
as [CollaborationController.broadcast](../Collaboration/CollaborationController.md#broadcast) (32KB when serialized). Because
...
| Parameter      | Type                                                        | Description                                                        |
| -------------- | ----------------------------------------------------------- | ------------------------------------------------------------------ |
| `params`       | \{ `state`: [`JsonValue`](../Collaboration/JsonValue.md); } | -                                                                  |
| `params.state` | [`JsonValue`](../Collaboration/JsonValue.md)                | The opaque, JSON-serializable state to publish for this extension. |
...
> **onBroadcast**(`params`: \{ `handler`: (`event`: [`BroadcastEvent`](../Collaboration/BroadcastEvent.md)) => `void`; }): `VoidFunction`
...
| Parameter        | Type                                                                                         | Description                                                           |
| ---------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `params`         | \{ `handler`: (`event`: [`BroadcastEvent`](../Collaboration/BroadcastEvent.md)) => `void`; } | -                                                                     |
| `params.handler` | (`event`: [`BroadcastEvent`](../Collaboration/BroadcastEvent.md)) => `void`                  | The handler function called with each broadcast received from a peer. |
...
> **onBroadcastStateChange**(`params`: \{ `handler`: (`event`: [`BroadcastStateEvent`](../Collaboration/BroadcastStateEvent.md)) => `void`; }): `VoidFunction`
...
[CollaborationController.onBroadcast](../Collaboration/CollaborationController.md#onbroadcast) — when you care about the
...
| Parameter        | Type                                                                                                   | Description                                                             |
| ---------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| `params`         | \{ `handler`: (`event`: [`BroadcastStateEvent`](../Collaboration/BroadcastStateEvent.md)) => `void`; } | -                                                                       |
| `params.handler` | (`event`: [`BroadcastStateEvent`](../Collaboration/BroadcastStateEvent.md)) => `void`                  | The handler function called with each peer's current and updated state. |
