...
| `params.pageSize`?   | `number`                                                                                                                                                                                                                                                                                    | The number of features to return per page. Defaults to 20. Note: Requesting for large page can get slow.     |
| `params.select`?     | `string`\[]                                                                                                                                                                                                                                                                                 | The attributes to select from the features.                                                                  |
